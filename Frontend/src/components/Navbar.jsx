        ...
        <>
            <nav className="navbar_container">
                ...
                <div className="navbar_right" >
                    {/* <div className="dark_light_mode">Dark Mode</div> */}

                    {user ? (
                        <div  onClick={handle_logout_fun}>
                            <span className="navbar_right_btn" >Log Out </span>
                        </div>  


                    ) : (

                        <Link to="/signin" className="navbar_right_btn">
                            <span>Sign in</span>
